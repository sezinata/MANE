...
from args_parser_Link_Prediction_binaryclass_MANE_Attention import get_parser
...
def main():
    ...
    while epo <= params.epochs - 1:
        ...
        loss2 = model.supervision_link_binary_class(labels, common_nodes, train_splits_cur, ytrain, params.gamma)
        loss2.backward()
        ...
        loss3 = model.supervision_link_binary_class(labels, common_nodes, train_splits_cur, ytrain, params.gamma)
        loss3.backward()
