...
def get_parser():
    ...
    parser.add_argument('--read_pair', action='store_false',
                        help='Default is true. If true, enables you to use the pairs you already have with your own '
                             'deepwalk/node2vec setting')

    parser.add_argument('--input_graphs', nargs='?', help='Input graph path ',
    ...
    parser.add_argument('--dimensions', type=int, default=42,
                        help='Number of dimensions. Default is 128/|V|, i.e., 64 for 2 views, 128 for 1 view/network.')

    parser.add_argument('-allp','--att_link_label_path', nargs='?', default='data/labels/link/',
                        help='For semi-supervised attention model (link prediction), specifies train indices, '
                             'label path.')
    ...
    parser.add_argument('--cur_split', type=int, default=5,
                        help='For semi-supervised attention model, value between [1, nsplits], i.e., if nsplits=5, '
                             'cur_split is in between [1, 5].')
    ...
    parser.add_argument('--gamma', type=float, default=1000,
                        help='Attention hyperparameter. Default is 1000.')
